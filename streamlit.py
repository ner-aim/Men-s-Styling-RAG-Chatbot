...
def main():
    ...
    if question := st.chat_input("Do you need information on skincare or styling?"):
                ...
                if relative_paths != "None":
                    with st.sidebar.expander("Related Documents"):
                        for path in relative_paths:
                            cmd2 = f"select GET_PRESIGNED_URL(@CC_QUICKSTART_CORTEX_SEARCH_DOCS.DATA.DOCS, '{path}', 360) as URL_LINK from directory(@docs)"
